...
## [공통 기능]
### 회원가입, 로그인
- 사용자는 이메일, 비밀번호, 주소 등을 이용해 회원가입할 수 있다.
- 사용자는 가입 시 사용한 이메일, 비밀번호를 이용해 로그인할 수 있다.

### 개인 정보 관리
- 사용자는 마이페이지를 통해 개인 정보를 조회할 수 있다.
- 사용자는 개인 정보를 수정할 수 있다.
- 사용자는 회원을 탈퇴할 수 있다.

### 헬스장 조회
- 사용자는 주변 헬스장을 조회할 수 있다.
- 사용자는 특정 헬스장을 검색하여 조회할 수 있다.

### 트레이너 조회
- 사용자는 헬스장 별 트레이너를 조회할 수 있다.

## [일반 회원 기능]
### 리뷰 관리
- 일반 회원은 트레이너에 대한 리뷰를 작성할 수 있다.
- 일반 회원은 자신이 쓴 리뷰를 조회할 수 있다.
- 일반 회원은 자신이 쓴 리뷰를 수정할 수 있다.
- 일반 회원은 자신이 쓴 리뷰를 삭제할 수 있다.

## [트레이너 기능]
### 리뷰 관리
- 트레이너는 자신에게 달린 리뷰를 조회할 수 있다.
- 트레이너는 자신에게 달린 리뷰에 답글을 달 수 있다.
